...
<body>
    ...
    <div class="container-fluid  p-5 text-center my-3">
        <img src="https://www.yorkgraphicdesigners.co.uk/wp-content/uploads/2020/04/coronavirus_logo-2.jpg" width="70%">
        ...
        <div class="row text-center">
            <div class="col-4  text-warning">
                <div class="h-100 alert-warning shadow rounded-lg py-4">
                    ...
                    <small class="text-warning pl-3"><i
                            class="fas fa-arrow-up"></i><?php echo $data['cases_time_series'][$days_count]['dailyconfirmed']; ?></small>
            ...
            <div class="col-4 text-success">
                <div class="h-100 alert-success shadow rounded-lg py-4">
                    ...
                    <small class="text-success pl-3"><i
                            class="fas fa-arrow-up"></i><?php echo $data['cases_time_series'][$days_count]['dailyrecovered']; ?></small>
            ...
            <div class="col-4 text-danger">
                <div class="h-100 alert-danger shadow rounded-lg py-4">
                    ...
                    <small class="text-danger pl-3"><i
                            class="fas fa-arrow-up"></i><?php echo $data['cases_time_series'][$days_count]['dailydeceased']; ?></small>
...
for ($i = 1; $i <= $length_count; $i++) {
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container text-center">
            <span class="text-muted">copyright &copy;2020, <a href="https://www.linkedin.com/in/rahul26021999"
                    target="_blank">Rahul Gupta</a></span>
